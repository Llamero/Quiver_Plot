 ...
 * @author Ben
 */
public class Quiver_Plot implements PlugInFilter {
    ...
    public int setup(String arg, ImagePlus imp) {        
        ...
        return DOES_32;//Do not include DOES_STACKS, as this will call the GUI once for each slice
    }
